...
{
	[Route("/api/v1/edu/psychology")]
	public class EducationPsychologyController : EducationControllerBase
	{
		protected override EducationTutorial Tutorial => EducationTutorial.PsychologyAndFinance;

		private readonly IGrpcServiceProxy<ITutorialPsychologyService> _tutorialService;

		public EducationPsychologyController(IGrpcServiceProxy<ITutorialPsychologyService> tutorialService,
			IEncoderDecoder encoderDecoder, ISystemClock systemClock,
			ILogger<EducationPsychologyController> logger) : base(systemClock, encoderDecoder, logger) => _tutorialService = tutorialService;
