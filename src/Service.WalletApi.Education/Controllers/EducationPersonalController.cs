...
{
	[Route("/api/v1/edu/personal")]
	public class EducationPersonalController : EducationControllerBase
	{
		protected override EducationTutorial Tutorial => EducationTutorial.PersonalFinance;
		...
		public EducationPersonalController(IGrpcServiceProxy<ITutorialPersonalService> tutorialService,
			IUserRewardService userRewardService,
			IEncoderDecoder encoderDecoder, ISystemClock systemClock,
			ILogger<EducationPersonalController> logger) : base(systemClock, encoderDecoder, logger)
		{
