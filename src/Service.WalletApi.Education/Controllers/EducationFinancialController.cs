...
{
	[Route("/api/v1/edu/financial")]
	public class EducationFinancialController : EducationControllerBase
	{
		protected override EducationTutorial Tutorial => EducationTutorial.FinancialServices;

		private readonly IGrpcServiceProxy<ITutorialFinancialService> _tutorialService;

		public EducationFinancialController(IGrpcServiceProxy<ITutorialFinancialService> tutorialService,
			IEncoderDecoder encoderDecoder, ISystemClock systemClock,
			ILogger<EducationFinancialController> logger) : base(systemClock, encoderDecoder, logger) => 
