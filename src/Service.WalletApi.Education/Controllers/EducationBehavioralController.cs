...
{
	[Route("/api/v1/edu/behavioral")]
	public class EducationBehavioralController : EducationControllerBase
	{
		protected override EducationTutorial Tutorial => EducationTutorial.BehavioralFinance;
		...
		public EducationBehavioralController(IGrpcServiceProxy<ITutorialBehavioralService> tutorialService,
			IUserRewardService userRewardService,
			IEncoderDecoder encoderDecoder, ISystemClock systemClock,
			ILogger<EducationBehavioralController> logger) : base(systemClock, encoderDecoder, logger)
		{
